...
namespace Downloader.Blazor.Client.Shared
{
    ...
    public partial class MudMatrix<T> : MudTableBase
    {

        [Parameter]
        public IEnumerable<T> RowHeaders
        {
            get => Items;
            set => Items = value;
        }

        [Parameter] public IEnumerable<T> ColumnHeaders { get; set; }
        [Parameter] public IEnumerable<MudMatrixCell> CellData { get; set; }
        [Parameter] public SortDirection ColumnSortDirection { get; set; }
        [Parameter] public SortDirection RowSortDirection { get; set; }
        [Parameter] public bool AllowColumnSorting { get; set; } = true;
        [Parameter] public bool AllowRowSorting { get; set; } = true;
        [Parameter] public bool DisplayColumnHeaders { get; set; } = true;
        [Parameter] public bool DisplayRowHeaders { get; set; } = true;
    ...
    public class MudMatrixHeader
    {
        public string DisplayValue { get; set; }
        public string SortValue { get; set; }

        public MudMatrixHeader(string displayValue, string sortValue)
        {
    ...
    public class MudMatrixCell
    {
        public MudMatrixHeader RowHeader { get; set; }
        public MudMatrixHeader ColHeader { get; set; }
        public object Value { get; set; }

        public MudMatrixCell(MudMatrixHeader rowHeader, MudMatrixHeader colHeader, object value)
        {
            RowHeader = rowHeader;
            ColHeader = colHeader;
            Value = value;
